...
install    -m 755 %{SOURCE5} %{buildroot}/%{_sbindir}/%{name}
...
%changelog
* Wed Aug 23 2017 Frankie Dintino <fdintino@gmail.com> - 8.0.24-1
- Refactor into a proper dist-git specfile
- Update to 8.0.24

* Thu Sep 04 2014 Edward Bartholomew <edward@bartholomew> - 7.0.55-1
- Update to 7.0.55

* Mon Jul 01 2013 Nathan Milford <nathan@milford.io> - 7.0.41-1
- Update to 7.0.41-1
